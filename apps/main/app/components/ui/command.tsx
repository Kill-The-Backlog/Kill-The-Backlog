...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <CheckIcon className="ml-auto opacity-0 group-has-data-[slot=command-item-check]/command-item:hidden group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  );
}
